...
echo "<div class='alert alert-warning mt-4' role='alert'>
                <p>El perfil ya se encuentra en la base de datos.</p>
                <p><a>Please login here</a></p>
            </div>";
} else {	
...
$passHash = crypt($pass, PASSWORD_DEFAULT);

// Query to send Name, Email and Password hash to the database
$sql = "INSERT INTO users (nombre, apellido, edad, email, user_id, password, perfil) VALUES ('$nombre',
'$apellido','$edad','$email','$user_id','$passHash','$perfil')";
