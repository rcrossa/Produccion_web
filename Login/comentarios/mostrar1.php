			...
			<tbody>
				<?php foreach ($listarComentarios as $comentario) {?>
					<tr class="table-info">                
						...
						<td><a href="actualizar_comentarios.php?idproducto=<?php echo $comentario->getIdproducto()?>&accion=a">Actualizar</a> </td>
						<td><a href="administrar_comentarios.php?idproducto=<?php echo $comentario->getIdproducto()?>&accion=e">Eliminar</a>   </td>
					</tr>
				<?php }?>
			</tbody>
		</table>
