...
--
-- Host: localhost
-- Generation Time: Aug 28, 2020 at 05:42 AM
...
CREATE TABLE `productos` (
  ...
  `description_details` varchar(1000) NOT NULL,
...
INSERT INTO `productos` (`id`, `continente`, `pais`, `precio`, `descripcion`, `description_details`, `url`, `destacado`) VALUES
...
(3, 'Rob', 'ross', 38, 'rob@hotmail.com', 'rob', '1234', ''),
(4, 'a', 'r', 1, 'r', 'rrrrr', '1234', ''),
(5, 'a', 'r', 1, 'r', 'rrrrr', '1234', ''),
(16, 'Roberto', 'Rossa', 38, 'rcrossa@hotmail.com', 'Rossa', '$1$6F.GXmXl$2GnMDWn.bt5OSeIO7xXt91', 'admin');
