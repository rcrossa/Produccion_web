                        ...
                        <div class="filtrolugar">
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-10 col-md-6 col-lg-4">
                                    <form action="" method="GET" class="">
                                        <?php $opcionPais = 'pidcontinente'; ?>
                                        <?php !empty($_GET['pidcontinente']) ? $opcionPais=$_GET['pidcontinente']: $opcionPais= "pidcontinente" ?>
                                         <input type="hidden" name="continente" value="<?php echo isset($opcionContinen) ? $opcionContinen  : $_GET['contid']?>">
                                        <select name="pais" class="custom-select custom-select-lg" id="pais" onchange="this.form.submit()">
                                            ...
                                            <?php foreach ($dataPaises as $paises) : ?>
                                                <?php if ($paises['paidcontinente'] == $opcionContinen) : ?>
