            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-4 my-3">
              <div class="card carta">
                ...
                <div class="card-body">
                  <h5 class="card-title1 font-weight-bold"><?php echo $value["ciudades"]; ?></h5>
                  ...
                  <div class="container d-flex justify-content-around">
                    ...
                    <?php echo '<a href="product_details.php?id=' . $value["nombre"] . '"class="btn btn-outline-primary">Ver mas</a>' ?>
                  </div>
                </div>
              </div>
            </div>