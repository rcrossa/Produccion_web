                                ...
                                <div class="col-12 col-md-6 col-lg-4 py-2">
                                    <form action="" method="GET" class="">
                                        ...
                                        <select name="continente" class="custom-select custom-select-lg" id="continente"
                                            ...
                                            <option
                                                <?php echo ($opcionContinen == $continentes['nombre']) ? 'selected="selected"' : '' ?>>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <form action="" method="GET" class="">
                                        ...
                                        <input type="hidden" name="pais"
                                            value="<?php echo isset($opcionPais) ? $opcionPais : $_GET['pais'] ?>">
                                        <?php !empty($_GET['ciudades']) ? $opcionCiudad=$_GET['ciudades']: $opcionCiudad = "Todo" ?>
                                        <select name="ciudades" class="custom-select custom-select-lg" id="ciudades"
                                            onchange="this.form.submit()">
                                            <option value="">Seleccionar Ciudad</option>
                                            <?php foreach ($dataCiudades as $ciudades) : ?>
                                            <?php if ($ciudades["pais"] == $opcionPais) : ?>
                                            <option
                                                <?php echo ($opcionCiudad == $ciudades['ciudades']) ? 'selected="selected"' : ''?>>
