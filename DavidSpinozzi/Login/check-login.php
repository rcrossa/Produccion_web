                                                ...
                                                if(isset($row['password'])){
                                                    ...
                                                    $_SESSION['expire'] = $_SESSION['start'] + (2 * 60) ;						
                                                            if($_SESSION['accion']=="ver" || $_SESSION['tipo_rol']=="productos"){
                                                                echo "<div class='alert alert-success mt-4' role='alert'><strong>Bienvenido $row[nombre] $row[apellido]</strong>			
                                                                <p><a href='../Login/index.php'>Ir al panel de usuarios</a></p>
