...
<div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="loginBox">
                        <img src="../images/logo_delfos.png" class="img-responsive" alt="PHP MySQL logos">
                        <h2>Login</h2>
                        ...
                        <p>¿Tienes que crear una cuenta? <button onclick="window.location.href='index.php'" type="button" class="btn btn-primary btn-sm">Click aqui!</button></p>
                    </div><!-- /.loginBox -->
                </div><!-- /.card -->
            </div><!-- /.col -->
        </div>
