...
<table class="table table-bordered tablamostrar1 ">
		...
		<tbody>
			...
			<tr class="table-info">                
				...
				<td><a href="actualizar.php?id=<?php echo $producto->getIdproducto()?>&accion=a">Actualizar</a> </td>
				<td><a href="administrar_producto.php?id=<?php echo $producto->getIdproducto()?>&accion=e">Eliminar</a>  </td>
			</tr>
			<?php }?>
		</tbody>
	</table>
